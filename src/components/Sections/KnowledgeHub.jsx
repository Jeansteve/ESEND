        ...
        <div className="w-full">
          {loading ? (
            ...
            <>
              ...
              {/* Bouton Mobile à la fin */}
              <motion.div 
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="flex md:hidden mt-12 justify-center"
              >
                <button
                  onClick={handleViewAll}
                  className="w-full px-8 py-5 bg-slate-900 text-white font-black uppercase tracking-wider text-[10px] rounded-2xl hover:bg-red-600 transition-all flex items-center justify-center gap-3 group shadow-xl border border-white/5"
                >
                  Explorer le Journal expert
                  <ArrowRight className="w-4 h-4 group-hover:translate-x-1.5 transition-transform duration-300" />
                </button>
