      ...
      <div className="max-w-7xl mx-auto px-8 md:px-12 lg:px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-12 md:mb-24 gap-12">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-[var(--bg-card)] border border-[var(--border-subtle)] p-10 rounded-[3rem] text-center backdrop-blur-3xl shadow-2xl relative w-full max-w-[320px] md:max-w-[380px]"
          >
          ...
          <AnimatePresence>
            {visibleReviews.map((review, index) => (
              <motion.div 
                ...
                className="min-w-[82vw] md:min-w-0 scroll-snap-item"
              >
        ...
        {!isMobile && !isExpanded && reviews.length > 6 && (
          ...
          >
            <button 
              ...
              className="inline-flex items-center gap-4 px-10 py-5 bg-[var(--bg-secondary)] border border-[var(--border-subtle)] text-[var(--text-main)] rounded-3xl font-black uppercase tracking-widest text-xs hover:bg-[var(--accent-red)] hover:text-white transition-all hover:scale-105 active:scale-95 group shadow-2xl"
            >
              Découvrir plus d'avis
              <div className="w-8 h-8 bg-white rounded-xl flex items-center justify-center group-hover:scale-110 transition-all shadow-inner">
