...
import { Bug, Rat, Home, Building2, MapPin, User, MessageSquare, Phone, Mail, Check, Star, Zap, Trash2, ShieldCheck, SprayCan } from 'lucide-react';
                ...
                {currentStepData.id === 'pest' && (
                  <motion.div key="s_pest" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                      {[{n:'Cafard', i:<Bug/>}, {n:'Fourmis', i:<Bug/>}, {n:'Abeille', i:<Bug/>}, {n:'Souris', i:<Rat/>}, {n:'Frelons', i:<Bug/>}, {n:'Punaise de lit', i:<Bug/>}, {n:'Autre', i:<MessageSquare/>}].map(s => (
