            ...
            <div className="grid lg:grid-cols-3 gap-6">
              {relatedArticles.map((article, index) => (
                <motion.article 
                  ...
                  className="group bg-white/[0.02] border border-white/5 rounded-3xl overflow-hidden hover:border-cyan-500/30 transition-all flex flex-col"
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <button className="text-cyan-500 text-[10px] font-black uppercase tracking-widest flex items-center gap-2 group/btn">
