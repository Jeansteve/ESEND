  ...
  const homeSchema = [
    {
      ...
      "priceRange": "$$",
      "areaServed": ["Menton", "Monaco", "Roquebrune-Cap-Martin"],
      "description": "Expert multiservices à Menton et ses environs (Monaco) : dératisation, désinsectisation, désinfection et nettoyage professionnel. Devis gratuit et rapide."
    },
    {
      "@context": "https://schema.org",
      "@type": "BreadcrumbList",
  ...
  return (
    <div className="transition-colors duration-400">
      <SEO 
        ...
        description="ESEND : Expert multiservices en dératisation, désinsectisation, désinfection et nettoyage à Menton et ses environs (Monaco). Devis gratuit et rapide."
        schema={homeSchema}
      />
      <Hero />
